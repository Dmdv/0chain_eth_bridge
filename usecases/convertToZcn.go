...
// Flow:
// 1. User sends transaction to Ethereum bridge smart contract to burn ETH. -> TransactionID // TODO:
// 2. User sends transaction ID to authorizers // TODO: Handle EthIDTransaction
